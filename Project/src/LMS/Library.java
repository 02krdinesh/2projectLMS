...
public class Library {
    ...
    public static ArrayList<Entity> persons;            // all clerks and borrowers
    private ArrayList<Book> booksInLibrary;             // all books in library are here!
    
    ArrayList<Loan> loans;                      // history of all books which have been issued
    ...
    HoldRequestOperations holdRequestsOperations = new HoldRequestOperations();
    ...
    public ArrayList<Entity> getPersons()
    {
        return persons;
    }
    ...
    // Persistence and SQL logic moved to LibraryDatabase class.
