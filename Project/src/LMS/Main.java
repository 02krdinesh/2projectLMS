...
public class Main {
    ...
    public static void allFunctionalities(Entity person, int choice) throws IOException {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        String pass = "Dinesh@1";
        LibraryDatabase libdb = new LibraryDatabase(jdbcURL, username, pass);
        Library lib = Library.getInstance();
        ...
        Connection con = libdb.makeConnection();
